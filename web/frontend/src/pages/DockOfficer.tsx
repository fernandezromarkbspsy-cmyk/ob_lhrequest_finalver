...
export default function DockOfficer() {
  const [filter, setFilter] = useState<RequestsFilter>({ queue: 'dock' })
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1 className="page-title">Dock Officer</h1>
          <p className="page-subtitle">Docking queue — verify and confirm trucks</p>
        </div>
      </div>
